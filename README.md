...
![Estes Alpha III airframe](docs/estes_alpha_airframe.png)

#### AeroTech J800T (75mm Carbon Fibre)

![J800 75mm airframe](docs/j800_airframe.png)

## Results Summary

All results from 50-episode evaluations with ICM-20948 IMU noise. Full details in [`docs/experimental_results.md`](docs/experimental_results.md).
...
The results in [`docs/experimental_results.md`](docs/experimental_results.md) are produced by the pipeline below. Steps are listed in dependency order: later steps require outputs from earlier steps.
...
```
compare_controllers.py          Main evaluation tool (Steps 4-9)
...
optimization_results/           Gain optimization JSON outputs (gitignored)
tests/                          Pytest test suite
visualizations/                 Plotting and animation scripts
hardware/                       Camera electronics and fin servo mount docs
